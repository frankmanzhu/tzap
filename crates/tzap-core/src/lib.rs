...
pub use reader::{
    ...
    open_seekable_archive_with_recipient_wrap_resolver_options, public_no_key_inspect_footer,
    public_no_key_verify_archive_with, public_no_key_verify_volumes_with,
    public_no_key_verify_volumes_with_options, sequential_extract_tar_stream,
    ArchiveContentVerification, ArchiveEntry, ArchiveExtractProgressSink, ArchiveIndexEntry,
    ArchiveReadAt, ArchiveRepairPatch, OpenedArchive, PublicNoKeyDiagnostic,
    PublicNoKeyFooterInspection, PublicNoKeyFooterStatus, PublicNoKeyVerification, ReaderOptions,

...
pub(crate) type CliRootAuthAuthenticator<'a> =
...
pub(crate) fn resolve_create_layout(
...
pub(crate) fn collect_one_input_spec(
    input: &Path,
    archive_path: &Path,
...
pub(crate) fn write_bootstrap_output_with_archive_rollback(
    path: &str,
    bytes: &[u8],
    output: &str,
    volume_count: usize,
...
pub(crate) fn flush_archive_output_temps(
...
pub(crate) fn publish_archive_output_temps(
...
pub(crate) fn create_dry_run_output_paths(
    output: &str,
    volumes: Option<u32>,
    has_volume_size: bool,
) -> Vec<String> {
...
pub(crate) fn root_auth_authenticator_value(
